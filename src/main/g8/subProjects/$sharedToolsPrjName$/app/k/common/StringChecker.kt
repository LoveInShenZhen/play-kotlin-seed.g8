...
object StringChecker {
    ...
    fun isMale(id: String): Boolean {
        ...
        if (StringUtil.isEmpty(result)) {
            if (id.length == 15) {
                return if (id.substring(14, 15).toInt() % 2 == 0)
                    false
                else
                    true
            } else if (id.length == 18) {
                return if (id.substring(16, 17).toInt()  % 2 == 0)
                    false
                else
                    true
            }
     ...
     * @return
     */
    fun checkEmail(value: String, length: Int): Boolean {
     ...
     * @return 验证通过返回true
     */
    fun checkTel(str: String): Boolean {
     ...
     * @return
     */
    fun checkAge(value: String): Boolean {
    ...
    fun checkHtmlTag(value: String): Boolean {
     ...
     * @return
     */
    fun checkURL(value: String): Boolean {
     ...
     * @return
     */
    fun checkIP(value: String): Boolean {
    ...
    fun checkQQ(value: String): Boolean {
     ...
     * @return
     */
    fun checkPostCode(value: String): Boolean {
     ...
     * @return
     */
    fun checkCarPlate(value: String): Boolean {
